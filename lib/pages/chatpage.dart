...
class _ChatPageState extends State<ChatPage> {
            ...
            decoration: BoxDecoration(
                ...
                gradient: sendByMe
                    ? LinearGradient(colors: [
                        Color.fromARGB(255, 231, 215, 255),
                        Color.fromARGB(255, 139, 99, 251)
                      ], begin: Alignment.topLeft, end: Alignment.bottomRight)
                    : LinearGradient(colors: [
                        Color.fromARGB(255, 239, 251, 255),
                        Color.fromARGB(255, 177, 191, 255)
                      ], begin: Alignment.topLeft, end: Alignment.bottomRight)),
            // color: sendByMe
            //     ? Color.fromARGB(255, 160, 191, 253)
            //     : Color.fromARGB(255, 17, 106, 184)),
            child: Text(
              message,
              style: TextStyle(
                  color: Colors.black,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        backgroundColor: Color.fromARGB(255, 102, 16, 173),
        body: Container(
